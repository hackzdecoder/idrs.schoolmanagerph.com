...
const StyledTextField = styled(
  ...
  [`& .${formLabelClasses.root}`]: {
    ...
    fontSize: 12,
    color: '#475569', // Darker color for labels
  ...
  [`& .${inputBaseClasses.root}`]: {
    ...
    [`& .${inputBaseClasses.input}`]: {
      ...
      '&::-webkit-input-placeholder': {
        opacity: '1 !important',
        color: '#94a3b8', // Lighter but still readable placeholder
      },
      '&::-moz-placeholder': {
        opacity: '1 !important',
        color: '#94a3b8',
      ...
      '&.Mui-disabled': {
        color: '#64748b', // Readable disabled text
        WebkitTextFillColor: '#64748b', // Override browser default
      },
      ...(disabledSpinButton && {
        '&[type=number]': {
